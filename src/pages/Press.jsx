...
const Press = () => {
  ...
  return (
    <section className="px-4 sm:px-8 py-10 max-w-7xl mx-auto mt-24">
      <motion.div
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="relative w-full sm:max-w-xs">
            ...
            <input
              ...
              className="w-full border bg-white border-gray-300 rounded-lg pl-10 pr-4 py-2 outline-none focus:ring focus:ring-primary "
            />
          </div>
