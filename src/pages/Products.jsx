...
const Products = () => {
  ...
  }, [dispatch, currentPage, debouncedSearchTerm, selectedCategory, selectedBrand, selectedStatus]);

  // Get filter options
  const { categories, brands, statusOptions } = useMemo(() => {
    if (!allProductsFromStore) return { categories: [], brands: [], statusOptions: [] };
  ...
  }, [allProductsFromStore, debouncedSearchTerm, selectedCategory, selectedBrand, selectedStatus]);
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [debouncedSearchTerm, selectedCategory, selectedBrand, selectedStatus]);
  ...
  const renderProductCard = (product) => {
    ...
    return (
      <motion.div
        ...
        className="bg-[#f7f5f1] rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col"
      >
        {/* Product Image */}
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters */}
      <div className="bg-[#f7f5f1] rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        {showDeleteModal && productToDelete && (
          ...
          >
            <motion.div
              ...
              className="bg-[#f7f5f1] rounded-xl p-6 max-w-md w-full"
            >
